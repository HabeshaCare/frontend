          ...
          <Router>
            <Routes>
              <Route
                ...
                element={
                  <ProtectedRoute requiredRole="PharmacyAdmin">
                    <PharmacyProfile />
                  </ProtectedRoute>
                }
              />
              ...
              <Route
                ...
                element={
                  <ProtectedRoute requiredRole="LaboratoryAdmin">
                    <LaboratoryProfile />
                  </ProtectedRoute>
                }
              />
              ...
              <Route
                path="/healthcenter/dashboard"
                element={
                  <ProtectedRoute requiredRole="HealthCenterAdmin">
                    <HealthCenterDashboard />
                  </ProtectedRoute>
                }
              />
              <Route
                path="/healthcenter/profile"
                element={
                  <ProtectedRoute requiredRole="HealthCenterAdmin">
                    <HealthCenterProfile />
                  </ProtectedRoute>
