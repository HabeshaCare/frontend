...
import { fetchAdminInfo, fetchHealthCenterInfo } from "./sharePatients/lib";
...
const ReceptionDashboard = () => {
  const [activeLink, setActiveLink] = useState("share");
    ...
    () => fetchHealthCenterInfo({ token, healthCenterId }),
    {
      onSuccess: (healthCenterInfo) => {
        if (healthCenterInfo !== null && healthCenterInfo !== undefined)
          dispatch(updateHealthcenter(healthCenterInfo[0]));
      },
      onError: (error) => {
