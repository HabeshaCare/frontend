          ...
          <div className="flex flex-col border border-solid mt-4 md:ml-24 p-14 rounded-lg shadow-md">
            ...
            <div className={`grid grid-cols-1 gap-4 ${editMode && 'md:grid-cols-3 md:gap-6'}`}>
              <div>
                ...
                {editMode ? <ProfileValue value="Amen General Laboratory" /> : <Input />}
              </div>
            ...
            <div className="text-xl text-[#1F555D] font-semibold font-serif mb-4 pl-8 mt-6">Admin Info</div>

            <div className={`grid grid-cols-1 gap-4 ${editMode && 'md:grid-cols-3 md:gap-6'}`}>
              <div>
                <ProfileKey keyName="Full Name" />
                {editMode ? <ProfileValue value="Yeabsira Nigusse" /> : <Input />}
              </div>
            ...
            {!editMode && (
              <div className="flex justify-center">
                <Button className="my-6 bg-[#1F555D] text-white h-10 w-28">Save</Button>
              </div>
            )}
