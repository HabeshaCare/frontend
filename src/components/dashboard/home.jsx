...
const Home = () => {
  ...
  <svg fill="#E4F0EE" height="64px" width="64px" version="1.1" id="Capa_1" viewBox="-14.4 -14.4 88.80 88.80" stroke="#E4F0EE" strokeWidth="0.0006000000000000001" transform="rotate(0)">
  <g id="SVGRepo_bgCarrier" strokeWidth="0">
    <rect x="-14.4" y="-14.4" width="88.80" height="88.80" rx="44.4" fill="#8BA5A8" strokeWidth="0"></rect>
  </g>
  <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" stroke="#fffff" strokeWidth="1.56">
  ...
  <SheetContent className = "bg-[#A7C2C5]">
    <SheetHeader>
      <SheetTitle className = "mb-4 bg-teal-900 text-white px-4 py-2 mr-4 rounded-md">GuideBot</SheetTitle>
            ...
            <div>
                <div className="bg-gradient-to-b from-[#E4F0EE] to-[#1F555D] h-full pb-8">
                 ...
                 <div className="mt-8">
                    ...
                    <Button className="mx-8 my-8 font-medium text-white w-40 h-12 bg-[hsl(188,44%,42%)] text-xl">View Records</Button>
                 </div>
